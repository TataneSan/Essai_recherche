...
<a href="/admin/gifts" class="transition duration-700 ease-in-out ml-4 px-3 py-2 rounded-md text-2x1 font-medium text-red-800 hover:text-white hover:bg-gray-800 focus:outline-none focus:text-white focus:bg-gray-700">Gifts</a>
<a href="/admin/dox" class="transition duration-700 ease-in-out ml-4 px-3 py-2 rounded-md text-2x1 font-medium text-red-800 hover:text-white hover:bg-gray-800 focus:outline-none focus:text-white focus:bg-gray-700">DoxsAdmin</a>
...
<center>
                                            <div class="form" style="">
                                                <h5 class="title">Total Searches</h5>
                                                <h2 class="subtitle"><?php echo $totalSearch;?></h2>
                                            </div>
                                            <div class="form">
                                                <h5 class="title">Total Users</h5>
                                                <h2 class="subtitle"><?php echo $totalUsers;?></h2>
                                            </div>
                                        </center>
</html>
